...
- `data/link_candidates.md` — все ссылки и текст рядом с ними для будущей замены на Markdown-ссылки.
...
- таймауты игнорирования: `КК-1 → КК-6`, `КК-6 → КК-20`, `КК-20 → КК-28`.
...
Перед заменой ссылок см. `data/link_candidates.md`.
